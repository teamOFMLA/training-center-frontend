...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const getPageTitle = () => {
    ...
    return activeItem ? activeItem.name : 'Management System';
  };
  ...
  return (
    <div className={`min-h-screen flex bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 transition-colors duration-200`}>
      ...
      {/* Sidebar Navigation */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 border-r border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/90 flex flex-col transition-transform duration-300 lg:translate-x-0 lg:static lg:h-screen ${
        ...
        <div className="h-16 px-6 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] font-medium text-zinc-500 tracking-wider uppercase">Portal v1.0</span>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative max-w-xs hidden md:block">
              ...
              <input
                ...
                className="w-48 xl:w-64 pl-9 pr-4 py-1.5 text-xs rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 text-zinc-800 dark:text-zinc-200 focus:outline-none focus:ring-1 focus:ring-zinc-900 dark:focus:ring-zinc-50 transition-all"
              />
            </div>
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-500 dark:text-zinc-400 transition-colors"
              title="Toggle theme"
            >
            ...
            <button className="relative p-2 rounded-xl border border-zinc-200 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-500 dark:text-zinc-400 transition-colors">
        ...
        <footer id="app-footer" className="h-12 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 py-3 px-6 flex items-center justify-between text-xs text-zinc-500 shrink-0 z-10 select-none">
          <div className="flex items-center gap-2">
            <span className="font-bold tracking-wider uppercase text-[10px] text-zinc-400">EduCenter Portal</span>
            <span className="text-zinc-300 dark:text-zinc-700">|</span>
            <span>&copy; {new Date().getFullYear()} EduCenter. All rights reserved.</span>
          </div>
